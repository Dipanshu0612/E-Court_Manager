...
const UserUpcomingHearings = () => {
  ...
  return (
    <>
      <UserHeader />
      <div className="p-6 border border-gray-300 rounded-lg bg-slate-50 shadow-md">
...
export default UserUpcomingHearings;
