                        ...
                        {hearings.map((hearing) => (
                            <li key={hearing.id} className="p-4 border border-gray-300 rounded-lg bg-white hover:bg-gray-100 transition duration-300 shadow-md cursor-pointer hover:scale-105">
                                <div className='flex items-center justify-between'>
                                    ...
                                    <div className='mx-5'>
                                        <h5>Lawyer Name: ABCD</h5>
                                        <h5>User Name: XYZ</h5>
                                    </div>
                                    <div className='mx-5'>
                                        <button className='p-2 bg-green-400 hover:bg-green-600 rounded-md'>Mark as Finished</button>
                                    </div>
                                </div>
                            </li>
                        ))}
...
export default JudgeUpcomingHearings;
